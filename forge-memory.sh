...
FORGE_DB="${FORGE_DB_PATH:-${FORGE_WORKSPACE_DIR:-.forge}/forge-memory.db}"
FORGE_DB_VERSION="1"
...
memory_export_startup_report() {
  ...
  cat > "${FORGE_STARTUP_REPORT_FILE:-${FORGE_WORKSPACE_DIR:-.forge}/forge-startup-report.md}" <<MDEOF
...
MDEOF
  ...
  ok "Startup report written: ${FORGE_STARTUP_REPORT_FILE:-${FORGE_WORKSPACE_DIR:-.forge}/forge-startup-report.md}"
}
